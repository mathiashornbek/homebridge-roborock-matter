...
- 🛡️ **Verified by Homebridge.** Reviewed and endorsed by the Homebridge team. 493 automated tests, zero known vulnerabilities, no analytics, and a startup designed to never crash your Homebridge — even when your Wi-Fi or the Roborock cloud has a bad day.
