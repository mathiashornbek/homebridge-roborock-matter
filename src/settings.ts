...
export const PLUGIN_NAME = "homebridge-roborock-vacuum";
...
// migrate.
export const HAP_PLUGIN_IDENTIFIER = "homebridge-roborock-matter";

// The platform the plugin creates (see config.json).
export const PLATFORM_NAME = "RoborockVacuumPlatform";
